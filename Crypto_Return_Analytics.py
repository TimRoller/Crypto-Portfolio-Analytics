...
cryptocurrencies = ['BTC-USD', 'ETH-USD', 'ATOM-USD', 'ADA-USD', 'LTC-USD', 'DOT-USD', 'BAT-USD', 'DOGE-USD', 'AAVE-USD']
...
summary_table['Initial Price ($)'] = initial
summary_table['Current Price ($)'] = current
